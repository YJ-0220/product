...
-- CreateEnum
CREATE TYPE "app"."OrderStatus" AS ENUM ('PENDING', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "app"."ApplicationStatus" AS ENUM ('pending', 'accepted', 'rejected');
...
CREATE TABLE "app"."OrderRequest" (
    ...
    "status" "app"."OrderStatus" NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
