...
// import { getApplicationsBySeller, getSellerStats } from "@/api/order";
  ...
  const fetchSellerData = async () => {
    try {
      ...
      const mockApplications: Application[] = [
        {
          id: "1",
          orderRequestId: "order1",
          message: "고품질 제품으로 빠른 배송 가능합니다.",
          proposedPrice: 15000,
          estimatedDelivery: "2024-01-15",
          status: "PENDING",
          createdAt: "2024-01-10T10:30:00Z",
          orderRequest: {
            title: "고품질 LED 조명 100개",
        ...
        {
          id: "2",
          orderRequestId: "order2",
          message: "안전한 포장으로 배송하겠습니다.",
          proposedPrice: 25000,
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-purple-600">{stats.totalEarnings.toLocaleString()}P</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="space-y-4">
              {recentApplications.length === 0 ? (
                <p className="text-gray-500 text-center py-8">아직 신청한 주문이 없습니다.</p>
              ) : (
                recentApplications.map((application) => (
                  <div key={application.id} className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="text-sm text-gray-600 mb-2">
                      구매자: {application.orderRequest.buyer.name}
                    </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <div className="text-center">
                  ...
                  <span className="text-sm font-medium text-blue-700">주문 찾기</span>
                </div>
              </Link>
              ...
              >
                <div className="text-center">
                  ...
                  <span className="text-sm font-medium text-green-700">포인트 환전</span>
                </div>
              </Link>
              ...
              >
                <div className="text-center">
                  ...
                  <span className="text-sm font-medium text-purple-700">내 정보</span>
                </div>
              </Link>
              ...
              >
                <div className="text-center">
                  ...
                  <span className="text-sm font-medium text-orange-700">새로고침</span>
                </div>
              </button>
            </div>
          </div>
